...
import { DETAILED_BLOGS } from "@/constants/blogs";
...
function page({ params }: any) {
  ...
  const slugFromParams = params?.blogid;
  ...
  console.log("keys", Object.keys(DETAILED_BLOGS));

  useEffect(() => {
    const filtered_project =
      DETAILED_BLOGS?.[slug.replace(/\s+/g, "-").replace(/%20/g, " ")];
